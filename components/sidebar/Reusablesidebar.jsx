    ...
    <Sidebar visible={visible} onHide={onHide} position={position}>
      <div>
        ...
        <div className="mb-3">
          <Accordion multiple>
            {Object.keys(filterItems).map(category => (
              <AccordionTab key={category} header={category} className="font-light font-sm">
        ...
        <div className="mb-3 w-full">
          ...
          <Button icon="pi pi-angle-double-right" className=" w-full gap-2 ml-2 font-bold font-xl rounded-md bg-red-900 text-white p-2 ">Start Test Now</Button>
        </div>
